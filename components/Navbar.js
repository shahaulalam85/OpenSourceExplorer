    ...
    <>
      ...
      <div className={`settings-drawer ${isOpen ? "active" : ""}`}>
        ...
        <div className="settings-drawer-content">
          ...
          <div className="setting-group">
            ...
            <div className="sound-toggle-wrapper">
              <div className="sound-toggle-info">
                <span className="sound-toggle-title">Interactive Beeps</span>
                <span className="sound-toggle-desc">Synthesized audio triggers</span>
              </div>
          ...
          {/* Goal Tracker */}
          <div className="setting-group">
            <span className="setting-label">Contribution Goal</span>
            <div className="goal-tracker-card">
              <div className="goal-tracker-header">
                <span>Weekly Shortlist Target</span>
                <span className="goal-tracker-stat">
                  {savedCount} / {weeklyGoal}
                </span>
              </div>
              ...
              <div style={{ fontSize: "0.75rem", color: "var(--text-muted)", marginTop: "0.25rem" }}>
                {percentage >= 100
                  ? "🎉 Goal reached! You are ready to start contributing!"
                  : `Select ${weeklyGoal - savedCount} more repositories to reach your goal.`}
              </div>
